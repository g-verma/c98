    ...
    <div className={`flex flex-col ${className}`} style={{ backgroundColor: '#000000' }}>
      ...
      <div id="input-area" className="relative p-3 border-t border-gray-700/50 shrink-0">
        ...
        <button
          ...
          className="opacity-75 absolute -top-[107px] left-3 w-9 h-9 rounded-full bg-black/30 backdrop-blur-sm border-2 border-gray-500/50 hover:border-gray-400/60 hover:bg-black/40 shadow-lg hover:scale-110 transition-all z-10 flex items-center justify-center"
        >
